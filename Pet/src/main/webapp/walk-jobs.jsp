	...
	<div class="container">
		...
		: ""%>>초대형견(45kg이상)</option>
						...
						<div class="form-group col-md-2">
							<button type="submit" class="btn btn-primary mt-4"
								style="background-color: rgb(235, 111, 98); color: #ffffff; border-color: rgb(235, 111, 98);">검색</button>
						</div>
					</div>
				</form>
				<div class="text-right mb-3">
					...
					<a
						href="walk-jobs.jsp?sortBy=pay&filterLocation=<%=request.getParameter("filterLocation") != null
		? URLEncoder.encode(request.getParameter("filterLocation"), "UTF-8")
		: ""%>&filterDay=<%=request.getParameter("filterDay") != null ? URLEncoder.encode(request.getParameter("filterDay"), "UTF-8") : ""%>&filterTime=<%=request.getParameter("filterTime") != null ? URLEncoder.encode(request.getParameter("filterTime"), "UTF-8")
		...
		: ""%>"
				...
				<div class="table-responsive">
					<table
						class="table table-striped table-bordered fixed-layout-table"
				...
				<div class="d-flex justify-content-between align-items-center mb-3">
					<nav aria-label="Page navigation example" class="flex-grow-1">
					...
					<c:choose>
						<c:when test="${sessionScope.userId != null}">
							<button class="btn btn-primary float-right mb-3"
								style="background-color: rgb(235, 111, 98); color: #ffffff; border-color: rgb(235, 111, 98);"
