<%@page import="LocalStrays.Animal"%> <%@ page language="java"
...
<html>
  <head>
    ...
    <script
      ...
      src="//dapi.kakao.com/v2/maps/sdk.js?appkey=d4948263d9bbfca4b09376e303d5e533&libraries=services"
    ></script>
  </head>
  <body>
    <div class="animal-details">
      ...
      <p>
        ...
        <%=animal.getCareTel()%> <% String careFacilityAddress =
