      ...
      <form action="ProcessSignupServlet" method="post" onsubmit="return comparePasswords()">
         <div class="form-group">
            ...
            <div class="input-group">
               <input type="text" id="id" class="form-control" maxlength="10" name="id" required>
               <div class="input-group-append">
                  <button type="button" id="checkDuplicate" class="btn btn-outline-secondary">중복확인</button>
               </div>
            </div>
         ...
         <div class="form-group">
            ...
            <input type="password" id="password" class="form-control" maxlength="20" name="password" required>
         </div>
         <div class="form-group">
            <label for="confirmPassword">비밀번호 확인</label>
            <input type="password" id="confirmPassword" class="form-control" maxlength="20" name="confirmPassword" required>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            ...
            <div class="input-group">
               <input type="text" id="phone" class="form-control" maxlength="11" name="phone" required oninput="this.value = this.value.replace(/[^0-9]/g, '')">
               <div class="input-group-append">
                  <button type="button" id="verifyPhone" class="btn btn-outline-secondary" onclick="sendSMS()">본인인증</button>
               </div>
            </div>
         </div>
         <div class="form-group">
            ...
            <input type="text" id="sample6_address" class="form-control mb-2" placeholder="주소" name="address">
...
<div id="passwordMismatchModal" class="modal">
   <div class="modal-content">
       ...
       <button type="button" onclick="closePasswordMismatchModal()" class="btn btn-primary">확인</button>
   </div>
</div>
...
<div id="phoneVerificationModal" class="modal">
    <div class="modal-content">
        <h2>본인 인증</h2>
        <p>인증번호를 입력하세요:</p>
        <input type="text" id="verificationCode" class="form-control" placeholder="5자리 숫자를 입력하세요.">
