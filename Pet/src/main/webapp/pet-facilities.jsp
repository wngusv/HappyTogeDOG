         ...
         <div class="row justify-content-center">
            ...
            <div class="col-lg-10">
               <div class="map_wrap">
                  ...
                  <!-- 수정된 높이 -->
                  <ul id="category">
                     <li id="동물병원"><img src="/images/동물병원.png" alt="동물병원">동물병원</li>
                     <li id="애견용품"><img src="/images/애견용품.png" alt="애견용품">애견용품</li>
                     <li id="애견유치원"><img src="/images/애견유치원.png" alt="애견유치원">애견유치원</li>
                     <li id="애견카페"><img src="/images/애견카페.png" alt="애견카페">애견카페</li>
                     <li id="애견장례식장"><img src="/images/애견장례식장.png" alt="애견장례식장">애견장례식장</li>
                  </ul>
               </div>
            </div>
         </div>
