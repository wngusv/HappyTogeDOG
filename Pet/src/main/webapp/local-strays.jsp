	...
	<main>
		<div class="container">
			...
			<div class="local-government-buttons">
				<button onclick="showAnimals('all')">전체</button>
				<%
				...
				%>
				<button onclick="showAnimals('<%=government.getOrgdownNm()%>')"><%=government.getOrgdownNm()%></button>
				<%
				}
				%>
			</div>
...
<script>
	function showAnimals(orgCd) {
		var form = document.createElement("form");
		form.setAttribute("method", "post");
		form.setAttribute("action", "/AnimalServlet");

		var input = document.createElement("input");
		input.setAttribute("type", "hidden");
		input.setAttribute("name", "localGovernment");
		input.setAttribute("value", orgCd);
